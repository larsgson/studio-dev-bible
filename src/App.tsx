...
export default function App() {
  ...
  if (phase === 'audience') {
    return (
      <Shell step={1} totalSteps={6} eyebrow="Step 1 of 6">
        <Question
  ...
  if (phase === 'faith') {
    return (
      <Shell step={2} totalSteps={6} eyebrow="Step 2 of 6">
        <Question
  ...
  if (phase === 'language') {
    return (
      <Shell step={3} totalSteps={6} eyebrow="Step 3 of 6">
        <Question
  ...
  if (phase === 'cart') {
    return (
      <Shell step={4} totalSteps={6} eyebrow="Step 4 of 6">
        ...
        <div className="mt-8 flex items-center justify-between">
          ...
          <button
            ...
            onClick={() => {
              setQIndex(0)
              setPhase(applicableQuestions.length ? 'interview' : 'name')
            }}
  ...
  if (phase === 'interview' && currentQuestion) {
    ...
    return (
      <Shell step={5} totalSteps={6} eyebrow={`Step ${qIndex + 1} of ${applicableQuestions.length}`}>
  ...
  if (phase === 'name') {
    return (
      <Shell step={6} totalSteps={6} eyebrow="Last step">
        ...
        />
        <div className="mt-8 flex items-center justify-between">
          <BackLink onClick={() => setPhase(applicableQuestions.length ? 'interview' : 'cart')} />
          <button
            type="button"
    ...
    return (
      <Shell eyebrow="Live">
        <div className="text-center">
          ...
          <p className="mt-1 text-xs uppercase tracking-widest text-parchment/30">Demo only — this link and QR code are not real</p>

          <div className="mx-auto mt-8 max-w-sm rounded-2xl border border-white/10 bg-white/[0.03] p-6">
            <div className="mx-auto mb-4 flex h-40 w-40 items-center justify-center rounded-xl bg-white text-ink text-xs font-mono">
              QR CODE
            </div>
